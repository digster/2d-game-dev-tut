...
// ---- Camera now lives in engine/camera.js (promoted once the Simulations
// capstone became its 2nd consumer — the player.js move rule). expert.html loads
// engine/camera.js before this file, so `Camera` is already global here. ----
